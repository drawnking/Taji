...
public class FragmentHomeHotViewFirst extends LinearLayout {
	...
	public FragmentHomeHotViewFirst(final Context context) {
		...
		containerView = flater.inflate(R.layout.home_hot_page_first, null);
		testview = (TextView) containerView.findViewById(R.id.temptest);
		scrollView=(ObservableScrollView) containerView.findViewById(R.id.home_hot_page_scrollview);
		...
		viewPagerInsideContainer = (RelativeLayout) containerView
				.findViewById(R.id.viewpagercontainer);
		gridView = (GridView) containerView
				.findViewById(R.id.home_hot_page_gridview);
		...
		gridView.setAdapter(new SimpleAdapter(context, listItems,
				R.layout.home_hot_page_first_gridview_item,
				new String[] { "pic" },
...
//		});
		...
		swipeRefreshLayout.setOnSystemUiVisibilityChangeListener(new OnSystemUiVisibilityChangeListener() {
...
class ChildViewPagerAdapter extends PagerAdapter {
	...
	public ChildViewPagerAdapter(Context context, View containerView) {
		...
		imgLoading1.setImageResource(R.drawable.icon_tab_home_hot_loading);
		ImageView imgLoading2 = new ImageView(context);
		imgLoading2.setImageResource(R.drawable.icon_tab_home_hot_loading);
		ImageView imgLoading3 = new ImageView(context);
		imgLoading3.setImageResource(R.drawable.icon_tab_home_hot_loading);
		...
		pointContainer = (LinearLayout) containerView
				.findViewById(R.id.pager_point_container);
